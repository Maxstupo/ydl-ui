namespace Maxstupo.YdlUi.Core.YoutubeDl.Model {
    using System;
    ...
    public sealed class YdlArguments {
        ...
        [Argument("", QuotePolicy = QuotePolicy.Always, Order = int.MaxValue)]
        ...
        [ArgumentContainer] public YdlArgumentsGeneral General { get; set; } = new YdlArgumentsGeneral();
        [ArgumentContainer] public YdlArgumentsNetwork Network { get; } = new YdlArgumentsNetwork();
        [ArgumentContainer] public YdlArgumentsGeoRestriction GeoRestriction { get; } = new YdlArgumentsGeoRestriction();
        [ArgumentContainer] public YdlArgumentsVideoSelection VideoSelection { get; } = new YdlArgumentsVideoSelection();
        [ArgumentContainer] public YdlArgumentsDownload Download { get; } = new YdlArgumentsDownload();
        [ArgumentContainer] public YdlArgumentsFileSystem FileSystem { get; } = new YdlArgumentsFileSystem();
        [ArgumentContainer] public YdlArgumentsThumbnail Thumbnail { get; } = new YdlArgumentsThumbnail();
        [ArgumentContainer] public YdlArgumentsVerbosity Verbosity { get; } = new YdlArgumentsVerbosity();
        [ArgumentContainer] public YdlArgumentsWorkarounds Workarounds { get; } = new YdlArgumentsWorkarounds();
        [ArgumentContainer] public YdlArgumentsVideoFormat VideoFormat { get; } = new YdlArgumentsVideoFormat();
        [ArgumentContainer] public YdlArgumentsSubtitle Subtitle { get; } = new YdlArgumentsSubtitle();
        [ArgumentContainer] public YdlArgumentsAuthentication Authentication { get; } = new YdlArgumentsAuthentication();
        [ArgumentContainer] public YdlArgumentsAdobePass AdobePass { get; } = new YdlArgumentsAdobePass();
        [ArgumentContainer] public YdlArgumentsPostProcessing PostProcessing { get; } = new YdlArgumentsPostProcessing();
    ...
    public sealed class YdlArgumentsNetwork {
        ...
        [Argument("--socket-timeout")] public TimeSpan? SocketTimeout { get; set; } = null;
        ...
        [FlagArgument("--force-ipv4")] public bool ForceIp4 { get; set; }

        /// <summary>Make all connections via IPv6.</summary>
        [FlagArgument("--force-ipv6")] public bool ForceIp6 { get; set; }
    ...
    public sealed class YdlArgumentsVideoSelection {
        ...
        /// <summary>Download advertisements as well (experimental).</summary>
    ...
    public sealed class YdlArgumentsFileSystem {
        ...
        /// <summary>Use only video ID in file name.</summary>
        ...
        /// <summary>Write video annotations to a .annotations.xml file.</summary>
    ...
    public sealed class YdlArgumentsVerbosity {
        ...
        /// <summary>Contact the youtube-dl server for debugging.</summary>
    ...
    public sealed class YdlArgumentsPostProcessing {
        ...
        /// <summary>Prefer avconv over ffmpeg for running the postprocessors.</summary>
